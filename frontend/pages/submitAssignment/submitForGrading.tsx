...
export default function submitForGrading() {
    return (
        <>
                ...
                <div className="w-full max-w-md space-y-8">
                    <div>
                        ...
                        <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">
                            Your contract scored: {testContract.overallScore}
                        </h2>
                        <div
                            ...
                            <div className="grid grid-cols-3 border-solid border-2 rounded-md border-uni p-2">
                                <dt className="col-span-2 text-lg font-medium text-gray-900">Score for test 1:</dt>
                                <dt className="text-lg font-medium text-gray-900 text-right">{testContract.testOne}</dt>
                            </div>
                            <div className="grid grid-cols-3 border-solid border-2 rounded-md border-uni p-2">
                                <dt className="col-span-2 text-lg font-medium text-gray-900">Score for test 2:</dt>
                                <dt className="text-lg font-medium text-gray-900 text-right">{testContract.testTwo}</dt>
                            </div>
                            <div className="grid grid-cols-3 border-solid border-2 rounded-md border-uni p-2">
                                <dt className="col-span-2 text-lg font-medium text-gray-900">Score for test 3:</dt>
